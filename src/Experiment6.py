...
from ModelConstruct import Basic_GRU, Encoder2, Decoder3, MLPDecoder, EncoderDecoder
...
if __name__ == '__main__':
    ...
    encoder = Encoder2(input_dim=input_dim,
                       ...
                       dropout=dropout)
    decoder = Decoder3(input_dim=input_dim,
                       hidden_dim=hidden_dim,
                       num_layers=num_layers,
                       batch_first=batch_first,
                       dropout=dropout)
    ...
    saved_encoder = Encoder2(input_dim=input_dim,
                             ...
                             batch_first=batch_first,
                             dropout=dropout)
    saved_decoder = Decoder3(input_dim=input_dim,
                             hidden_dim=hidden_dim,
                             num_layers=num_layers,
                             batch_first=batch_first,
                             dropout=dropout)
    ...
    for epoch in tqdm(range(decoder_epoches)):
        train_loss = model_trainer.decoder_train2(train_loader=train_loader)
